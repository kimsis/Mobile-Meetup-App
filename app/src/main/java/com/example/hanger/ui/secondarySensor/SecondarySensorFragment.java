...
public class SecondarySensorFragment extends Fragment {

    private SecondarySensorViewModel notificationsViewModel;
private FragmentSecondarySensorBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
            ViewGroup container, Bundle savedInstanceState) {
        notificationsViewModel =
                new ViewModelProvider(this).get(SecondarySensorViewModel.class);
